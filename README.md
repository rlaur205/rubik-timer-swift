...
### 13.1 Cronómetro y Sesión Activa
El núcleo de la aplicación: visualización de tiempos con alta precisión, scrambles automáticos por categoría y estadísticas rápidas (Mo3, Ao5, Ao12) siempre a la vista.

| Cronómetro (Dark Mode) | Cronómetro (Light Mode) |
| :---: | :---: |
| ![Timer Dark](img/img_cronometroB.png) | ![Timer Light](img/img_cronometro.png) |
| *Interfaz enfocada en la sesión activa.* | *Estadísticas de sesión en tiempo real.* |


### 13.2 Gestión de Categorías y Sesiones
Soporte para múltiples puzzles de la WCA y creación de sesiones personalizadas con una interfaz intuitiva.

| Listado de Categorías (Dark) | Listado de Categorías (Light) | Nueva Sesión (Dark) | Nueva Sesión (Light) |
| :---: | :---: | :---: | :---: |
| ![Cat Dark](img/img_categoriasB.png) | ![Cat Light](img/img_categorias.png) | ![New Dark](img/img_agregarCategoriaPopUpB.png) | ![New Light](img/img_agregarCategoriaPopUp.png) |
| *Acceso rápido a puzzles.* | *Interfaz adaptativa.* | *Selector de puzzle.* | *Creación de sesión.* |


### 13.3 Historial y Control de Datos
Registro detallado de cada resolución con fecha y mezcla, incluyendo sistemas de seguridad para la gestión de datos.

| Historial de Tiempos | Confirmación de Borrado (Dark) | Confirmación de Borrado (Light) |
| :---: | :---: | :---: |
| ![Lista](img/img_tiempos.png) | ![Borrar Dark](img/img_eliminarTiemposB.png) | ![Borrar Light](img/img_eliminarTiempos.png) |
| *Detalle de cada solve.* | *Seguridad de datos en modo oscuro.* | *Seguridad de datos en modo claro.* |


### 13.4 Estadísticas Avanzadas y Gráficas
Análisis profundo del rendimiento mediante promedios históricos (PBs), desviación estándar y gráficas de tendencia.

| Estadísticas Detalladas | Gráficas de Rendimiento (Dark) | Gráficas de Rendimiento (Light) |
| :---: | :---: | :---: |
| ![Stats](img/img_estadisticas.png) | ![Grafica Dark](img/img_graficaB.png) | ![Grafica Light](img/img_grafica.png) |
| *Análisis de medias globales.* | *Visualización de PBs y tendencia.* | *Seguimiento visual del progreso.* |
